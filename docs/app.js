...
const LOCALES = {
  "en": {
    ...
    "chatMetadataNone": "The archive metadata for \"{query}\" did not match the current filters.",
    "chatMetadataFound": "The archive metadata for \"{query}\" has {count} matching records.",
